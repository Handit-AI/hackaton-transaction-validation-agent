...
This folder contains the implementation for the **decision_aggregator** LLM node of the risk_manager agent.
...
The decision_aggregator LLM node is responsible for:
...
```python
from src.nodes.llm.decision_aggregator.processor import DecisionAggregatorLLMNode

# Initialize the LLM node
node = DecisionAggregatorLLMNode(config)
