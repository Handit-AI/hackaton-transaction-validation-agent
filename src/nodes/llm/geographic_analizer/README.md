...
This folder contains the implementation for the **geographic_analizer** LLM node of the risk_manager agent.
...
The geographic_analizer LLM node is responsible for:
...
```python
from src.nodes.llm.geographic_analizer.processor import GeographicAnalizerLLMNode

# Initialize the LLM node
node = GeographicAnalizerLLMNode(config)
